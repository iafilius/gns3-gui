...
class QemuVMConfigurationPage(QtWidgets.QWidget, Ui_QemuVMConfigPageWidget):
    ...
    def loadSettings(self, settings, node=None, group=False):
        ...
        if not group:
            ...
            self.uiHdeDiskImageLineEdit.setText(settings["hde_disk_image"])
            self.uiHdfDiskImageLineEdit.setText(settings["hdf_disk_image"])
            self.uiHdgDiskImageLineEdit.setText(settings["hdg_disk_image"])
            self.uiHdhDiskImageLineEdit.setText(settings["hdh_disk_image"])
            ...
            self.uiHdeDiskInterfaceComboBox.setCurrentIndex(self.uiHddDiskInterfaceComboBox.findText(settings["hde_disk_interface"]))
            self.uiHdfDiskInterfaceComboBox.setCurrentIndex(self.uiHddDiskInterfaceComboBox.findText(settings["hdf_disk_interface"]))
            self.uiHdgDiskInterfaceComboBox.setCurrentIndex(self.uiHddDiskInterfaceComboBox.findText(settings["hdg_disk_interface"]))
            self.uiHdhDiskInterfaceComboBox.setCurrentIndex(self.uiHddDiskInterfaceComboBox.findText(settings["hdh_disk_interface"]))
    ...
    def saveSettings(self, settings, node=None, group=False):
        ...
        if not group:
            ...
            settings["hde_disk_image"] = self.uiHdeDiskImageLineEdit.text().strip()
            settings["hdf_disk_image"] = self.uiHdfDiskImageLineEdit.text().strip()
            settings["hdg_disk_image"] = self.uiHdgDiskImageLineEdit.text().strip()
            settings["hdh_disk_image"] = self.uiHdhDiskImageLineEdit.text().strip()
            ...
            settings["hde_disk_interface"] = self.uiHdeDiskInterfaceComboBox.currentText()
            settings["hdf_disk_interface"] = self.uiHdfDiskInterfaceComboBox.currentText()
            settings["hdg_disk_interface"] = self.uiHdgDiskInterfaceComboBox.currentText()
            settings["hdh_disk_interface"] = self.uiHdhDiskInterfaceComboBox.currentText()
